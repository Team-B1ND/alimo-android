...
class HomeCategoryRv constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeCategoryRv.ViewHolder {
        return ViewHolder(ItemCategoryBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }

    override fun getItemCount(): Int = items.size

    override fun onBindViewHolder(holder: HomeCategoryRv.ViewHolder, position: Int) {
        if (position != 0) {
